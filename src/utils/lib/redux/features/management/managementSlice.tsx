...
export const fetchProjects = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            const response = await axiosInstance.get('/api/versioning/projects/');
...
export const fetchDashboardOverview = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            const response = await axiosInstance.get('/api/versioning/all_status/');
