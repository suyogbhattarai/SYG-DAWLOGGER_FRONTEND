...
const initialState: AuthState = {
    ...
    recentlyViewed: storedAuth.recentlyViewed || [],
    adminUsers: [],
    adminUsersTotal: 0,
    selectedUser: null,
    userStats: null,
...
export const registerUser = createAsyncThunk(
    ...
    async (userData: any, { rejectWithValue }) => {
        try {
            // Using JSON instead of FormData to match backend serializer
            const payload = {
            ...
            // Response from accounts app uses success_response wrapper
            // { success: true, message: "...", data: { user, tokens: { access, refresh } } }
            ...
            if (typeof window !== 'undefined') {
                ...
                // Also save in authUser format for compatible axiosInstance
...
export const loginUser = createAsyncThunk(
    ...
    async (credentials: { username: string; password: string }, { rejectWithValue }) => {
        try {
            const response = await axiosInstance.post('/api/accounts/login/', credentials);
...
export const updateUserProfile = createAsyncThunk(
    ...
    async (formData: any, { rejectWithValue }) => {
        try {
            const response = await axiosInstance.put('/api/accounts/profile/', formData, {
                headers: {
