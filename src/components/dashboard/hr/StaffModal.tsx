...
export default function StaffModal({ onClose, onSubmit, submitting }: StaffModalProps) {
    ...
    const inputClass = "w-full bg-[#050b2b] border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#00d2ff] transition text-sm font-medium placeholder-gray-600";
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input required className={`${inputClass} pl-12`} placeholder="Arjun" value={formData.first_name} onChange={e => setFormData({ ...formData, first_name: e.target.value })} />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="relative">
                                        <MdPerson className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-600" />
                                        <input required className={`${inputClass} pl-12`} placeholder="Thapa" value={formData.last_name} onChange={e => setFormData({ ...formData, last_name: e.target.value })} />
                                    </div>
                                </div>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input required className={`${inputClass} pl-12`} placeholder="arjun_daw" value={formData.username} onChange={e => setFormData({ ...formData, username: e.target.value })} />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input required type="email" className={`${inputClass} pl-12`} placeholder="arjun@dawlogger.com" value={formData.email} onChange={e => setFormData({ ...formData, email: e.target.value })} />
                                    </div>
                                </div>
                            </div>
                            <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input className={`${inputClass} pl-12`} placeholder="Sound Engineer" value={formData.designation} onChange={e => setFormData({ ...formData, designation: e.target.value })} />
                                    </div>
                                </div>
                                <div>
                    ...
                    <div className="flex gap-4">
                        ...
                        {activeStep < 3 ? (
                            ...
                            <button
                                ...
                                disabled={submitting}
                                className="bg-[#00d2ff] hover:bg-[#e03229] text-white font-bold text-sm px-10 py-3 rounded-xl transition shadow-xl shadow-red-900/40 flex items-center gap-2"
                            >
