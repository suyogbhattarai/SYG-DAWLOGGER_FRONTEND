...
import { BrandSpinner } from '@/components/BrandSpinner/BrandSpinner'
import { ProfilePageSkeleton } from '@/components/ProfileSkeleton/ProfileSkeleton'
...
export default function ProfilePage() {
  ...
  if ((!isAuthenticated && !loading) || loading || !user) {
    // Show skeleton loading state while determining auth or fetching user
    return (
      <div className="min-h-screen bg-[#071236]">
        <Navbar />
        <div className="min-h-screen pt-32 pb-20 max-w-[1920px] mx-auto lg:px-15 md:px-10 sm:px-5 px-5">
          <ProfilePageSkeleton />
        </div>
        <Footer />
      </div>
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#071236] pt-32 pb-20">
        <div className="max-w-[1920px] mx-auto lg:px-15 md:px-10 sm:px-5 px-5">
          ...
          {/* Profile Header */}
          <div className="bg-gradient-to-br from-[#111e48] to-[#071236] rounded-2xl shadow-xl p-8 border border-white/10 mb-8 overflow-hidden relative">
              ...
              {isEditing ? (
                ...
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                    <div className="bg-gradient-to-br from-[#111e48]/80 to-[#071236] rounded-2xl shadow-xl p-8 border border-white/10 group hover:border-red-500/30 transition-all duration-300">
                      <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
                        <span className="text-red-500 text-2xl">📋</span> Account Information
                      </h3>
                    ...
                    {(isAdmin || isStaff) && (
                      <div className="bg-gradient-to-br from-[#111e48]/80 to-[#071236] rounded-2xl shadow-xl p-8 border border-white/10 group hover:border-red-500/30 transition-all duration-300">
                        <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
                          <span className="text-red-500 text-2xl">🔐</span> Admin Info
                        </h3>
                        <div className="space-y-4">
                          <div>
