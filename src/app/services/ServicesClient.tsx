            ...
            <div className={`transition-opacity duration-700 ${isGsapReady && !servicesLoading ? 'opacity-100' : 'opacity-0'}`}>
                ...
                >
                    <div className="parallax-bg absolute inset-0 z-0 h-[140%] -top-[20%] w-full">
                        <div className="absolute inset-0 w-full h-full">
                            ...
                            <div className="absolute top-0 right-0 w-[60vw] h-[60vw] bg-[#00d2ff]/12 blur-[200px] rounded-full -translate-y-1/2 translate-x-1/3 pointer-events-none z-10" />
                    ...
                    <div className="relative z-20 w-full max-w-[1920px] mx-auto px-5 text-center">
                        <div className="max-w-4xl mx-auto content-fade flex flex-col items-center translate-y-[60px] md:translate-y-[100px]">
                            <span className="inline-block px-4 py-1.5 bg-[#00d2ff] text-white text-[10px] uppercase tracking-widest rounded-full mb-6 font-bold shadow-lg shadow-cyan-500/20">
                                Cloud & Audio Solutions
                            </span>
                            <h1 className="text-3xl md:text-[55px] font-bold text-white mb-6 leading-tight drop-shadow-xl shadow-black">
                                Our Specialized <br />
                                <span className="text-[#00d2ff]">Audio Services.</span>
                            </h1>
                            <p className="text-gray-100 font-normal text-base md:text-lg leading-relaxed mb-8 max-w-2xl drop-shadow-md">
                                From secure cloud storage to advanced AI stem separation, we provide the infrastructure for modern music production.
                            </p>
                            <div className="flex gap-4 cursor-pointer" onClick={() => {
                                window.scrollBy({ top: window.innerHeight, behavior: 'smooth' });
                            }}>
                                <a href="/getquote" className="bg-[#00d2ff] hover:bg-[#3a7bd5] text-white px-8 py-3 rounded-full font-bold text-xs uppercase tracking-wider transition-all shadow-lg shadow-cyan-500/20">
                                    Request Quote
                                </a>
                ...
                {services.map((service, index) => (
                    ...
                    >
                        <div className="parallax-bg absolute inset-0 z-0 will-change-transform h-[140%] -top-[20%] w-full">
                            ...
                            />
                            {/* Portfolio Glow Elements - Calibrated Vibrancy */}
                            <div className={`absolute ${index % 2 === 0 ? 'top-0 right-0' : 'bottom-0 left-0'} w-[60vw] h-[60vw] bg-[#00d2ff]/10 blur-[180px] rounded-full z-10 pointer-events-none opacity-70`} />
                        ...
                        <div className="relative z-10 w-full max-w-[1920px] mx-auto lg:px-20 md:px-10 px-5">
                            <div className={`max-w-2xl flex flex-col ${index % 2 === 0 ? 'items-start text-left' : 'ml-auto items-end text-right'} mt-24 md:mt-40`}>
                                <div className="content-fade mb-6">
                                    <div className={`inline-flex items-center justify-center w-16 h-16 bg-[#00d2ff] rounded-2xl shadow-lg shadow-cyan-500/30 overflow-hidden`}>
                                ...
                                <p className={`content-fade text-gray-400 text-sm md:text-base leading-relaxed mb-8 max-w-lg font-medium ${index % 2 !== 0 ? 'ml-auto' : ''}`}>
                                    {service.description || 'Professional audio service for studio and enterprise needs.'}
                                </p>

                                <div className="content-fade flex gap-4">
                                    <Link
                                        href={`/getquote?service=${service.id}`}
                                        className="bg-[#00d2ff] hover:bg-[#3a7bd5] text-white px-8 py-3 rounded-full font-black text-[10px] uppercase tracking-widest transition-all shadow-lg shadow-cyan-500/20"
                                    >
                                        Inquire Now
                                    </Link>
                                    <Link
                        ...
                        <div className={`absolute bottom-10 z-20 hidden md:block ${index % 2 === 0 ? 'right-20' : 'left-20'}`}>
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-[10px] font-black text-[#00d2ff] uppercase tracking-[0.3em]">Services</span>
                            </div>
                        </div>
                    </section>
                ))}
                ...
                >
                    <div className="parallax-bg absolute inset-0 z-0 will-change-transform h-[140%] -top-[20%] w-full">
                        ...
                        />
                        <div className="absolute inset-0 bg-gradient-to-r from-[#050510] via-[#050510]/95 to-[#050510]/80" />
                    </div>
                    ...
                    <div className="relative z-10 w-full max-w-[1920px] mx-auto lg:px-15 md:px-10 px-5">
                        <div className="flex items-center justify-center min-h-[50vh]">
                            <div className="max-w-3xl content-fade text-center translate-y-[80px] md:translate-y-[120px]">
                                <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#00d2ff]/10 border border-[#00d2ff] rounded-full mb-6 mx-auto">
                                    <MdHandshake className="text-[#00d2ff]" />
                                    <span className="text-[#00d2ff] text-[10px] font-black uppercase tracking-widest">
                                        Enterprise Solutions
                                    </span>
                                </div>
                                <h2 className="text-3xl md:text-5xl font-black text-white mb-6 leading-tight">
                                    Studio Integration & <br />
                                    <span className="text-[#00d2ff]">Enterprise API Access.</span>
                                </h2>
                                <p className="text-gray-300 text-sm md:text-base leading-relaxed mb-8 mx-auto max-w-2xl">
                                    We partner with major studios and educational institutions to provide bulk licensing, custom API integration, and dedicated support. Scale your production workflow with our enterprise-grade infrastructure.
                                </p>
                                <div className="flex gap-4 justify-center">
                                    <a href="/getquote" className="bg-white text-[#050510] hover:bg-gray-100 px-8 py-3 rounded-full font-bold text-xs uppercase tracking-wider transition-all">
                                        Become a Partner
                                    </a>
