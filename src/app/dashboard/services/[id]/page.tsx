            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <div className="flex items-center gap-2 text-sm text-gray-400 mb-1">
                        ...
                        <span>/</span>
                        <span className="text-[#00d2ff]">{isNew ? 'New Service' : currentService?.title || 'Edit Service'}</span>
                    </div>
            ...
            <form onSubmit={handleSubmit} className="bg-[#111e48]/40 border border-white/5 rounded-[2.5rem] overflow-hidden">
                ...
                <div className="flex bg-[#050b2b] p-1 border-b border-white/5">
                    <button
                        ...
                        className={`flex-1 py-3 text-[10px] font-black uppercase tracking-widest transition ${activeTab === 'basic' ? 'bg-[#00d2ff] text-white' : 'text-gray-500 hover:text-white'}`}
                    >
                        Basic Info
                    </button>
                    <button
                        ...
                        className={`flex-1 py-3 text-[10px] font-black uppercase tracking-widest transition ${activeTab === 'images' ? 'bg-[#00d2ff] text-white' : 'text-gray-500 hover:text-white'}`}
                    >
                        Gallery Images
                    </button>
                    <button
                        ...
                        className={`flex-1 py-3 text-[10px] font-black uppercase tracking-widest transition ${activeTab === 'seo' ? 'bg-[#00d2ff] text-white' : 'text-gray-500 hover:text-white'}`}
                    >
                        SEO Settings
                    </button>
                </div>
                ...
                <div className="p-8">
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full bg-[#050b2b] border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#00d2ff] transition"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    rows={4}
                                    className="w-full bg-[#050b2b] border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#00d2ff] transition resize-none"
                            ...
                            <div className="flex items-center gap-3">
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="w-5 h-5 rounded bg-[#050b2b] border-white/10 text-[#00d2ff] focus:ring-[#00d2ff]"
                                />
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                                    ...
                                    {/* Upload Trigger */}
                                    <label className="aspect-square rounded-xl border-2 border-dashed border-white/10 bg-white/5 hover:bg-white/10 hover:border-[#00d2ff]/50 transition cursor-pointer flex flex-col items-center justify-center gap-2 group">
                                        <MdCloudUpload size={32} className="text-gray-500 group-hover:text-[#00d2ff] transition" />
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white/5 border border-white/5 rounded-xl p-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-cyan-500 text-xs text-center border-t border-white/5 pt-4">
                                        dawlogger.com › services › {formData.title.toLowerCase().replace(/\s+/g, '-') || 'service-name'}
                                    </p>
                    ...
                    <div className="flex gap-4 mt-8 pt-6 border-t border-white/5">
                        ...
                        <button
                            type="submit"
                            disabled={submitting}
                            className="flex-1 bg-[#00d2ff] hover:bg-[#e03229] text-white py-3 rounded-xl font-black text-sm uppercase tracking-widest transition disabled:opacity-50 disabled:cursor-not-allowed"
                        >
