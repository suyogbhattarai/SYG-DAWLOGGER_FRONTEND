...
export default function StaffDetailPage() {
    ...
    const getInputClass = (field: string) => {
        ...
        return `${baseClass} border-white/10 focus:border-[#00d2ff]`;
    };
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="flex items-center gap-2 text-sm text-gray-400 mb-1">
                            ...
                            <span>/</span>
                            <span className="text-[#00d2ff]">{isNew ? 'New Staff' : (currentStaff?.user_data?.username || currentStaff?.user_details?.username || 'Staff Profile')}</span>
                        </div>
            ...
            <div className="bg-[#111e48]/40 border border-white/5 rounded-[2rem] px-8 py-4 flex justify-between">
                {steps.map((step) => (
                    <div key={step.id} className="flex items-center gap-3">
                        <div className={`w-8 h-8 rounded-lg flex items-center justify-center text-sm font-bold transition-all ${activeStep >= step.id ? 'bg-[#00d2ff] text-white shadow-lg shadow-red-900/20' : 'bg-white/5 text-gray-500'}`}>
                    ...
                    <div className="space-y-6 animate-fadeIn">
                        <div className="flex flex-col items-center mb-8">
                            <div className="relative group">
                                <div className="w-24 h-24 rounded-[2rem] bg-[#050b2b] border-2 border-dashed border-white/10 overflow-hidden flex items-center justify-center text-gray-600 transition group-hover:border-[#00d2ff]/50">
                                    {previews.profile ? (
                                ...
                                <div className="absolute -bottom-2 -right-2 bg-[#00d2ff] text-white p-2 rounded-xl shadow-lg">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input required className={`${getInputClass('first_name')} pl-12`} placeholder="Arjun" value={formData.first_name} onChange={e => setFormData({ ...formData, first_name: e.target.value })} />
                                </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <MdPerson className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-600" />
                                    <input required className={`${getInputClass('last_name')} pl-12`} placeholder="Thapa" value={formData.last_name} onChange={e => setFormData({ ...formData, last_name: e.target.value })} />
                                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input required className={`${getInputClass('username')} pl-12`} placeholder="arjun_daw" value={formData.username} onChange={e => setFormData({ ...formData, username: e.target.value })} />
                                </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input required type="email" className={`${getInputClass('email')} pl-12`} placeholder="arjun@dawlogger.com" value={formData.email} onChange={e => setFormData({ ...formData, email: e.target.value })} />
                                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input className={`${getInputClass('designation')} pl-12`} placeholder="Sound Engineer" value={formData.designation} onChange={e => setFormData({ ...formData, designation: e.target.value })} />
                                </div>
                            </div>
                            <div>
                    ...
                    <div className="space-y-6 animate-fadeIn">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div className="relative border-2 border-dashed border-white/5 rounded-xl p-4 bg-[#050b2b] flex flex-col items-center justify-center text-gray-500 hover:border-[#00d2ff]/30 transition group cursor-pointer">
                            ...
                            <div className="relative border border-white/5 bg-[#050b2b] rounded-xl px-4 py-3 flex items-center justify-between">
                                ...
                                {formData.contract_doc && typeof formData.contract_doc === 'string' && (
                                    <a
                                        ...
                                        rel="noreferrer"
                                        download
                                        className="ml-2 text-[#00d2ff] hover:text-white transition"
                                    >
                    ...
                    <div className="flex gap-4">
                        ...
                        {activeStep < 3 ? (
                            <button
                                type="button"
                                onClick={() => setActiveStep(prev => prev + 1)}
                                className="bg-[#00d2ff] hover:bg-[#e03229] text-white font-bold text-sm px-8 py-3 rounded-xl transition shadow-lg shadow-red-900/20"
                            >
                                Next Step
                            </button>
                        ) : (
                            <button
                                type="submit"
                                disabled={submitting}
                                className="bg-[#00d2ff] hover:bg-[#e03229] text-white font-bold text-sm px-10 py-3 rounded-xl transition shadow-xl shadow-red-900/40 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
