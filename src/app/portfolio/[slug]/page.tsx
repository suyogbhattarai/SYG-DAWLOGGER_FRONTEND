...
export default function PortfolioItemPage() {
    ...
    if (loading) return <div className="min-h-screen bg-[#071236] flex items-center justify-center text-[#f6423a]">Initializing Project Specs...</div>;
                ...
                <div className="max-w-7xl mx-auto flex flex-col items-center text-center relative z-10">
                    ...
                    <div className="project-detail-animate flex flex-wrap justify-center gap-6 md:gap-12">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-xs font-black uppercase tracking-widest text-white/60">{project.location || 'Global'}</span>
                        </div>
                        <div className="flex items-center gap-3">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 mb-24">
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="project-detail-animate grid grid-cols-1 md:grid-cols-2 gap-8 pt-8">
                            <div className="p-8 bg-white/5 rounded-[2rem] border border-white/5">
                                <h4 className="text-[10px] font-black text-[#f6423a] uppercase tracking-widest mb-4">Production Scope</h4>
                                <ul className="space-y-4">
                                    {['Stem Management', 'Version Control', 'Producer Collaboration', 'Project Archiving'].map((item, i) => (
                            ...
                            <div className="p-8 bg-[#f6423a] rounded-[2rem] shadow-xl shadow-red-900/40">
                                ...
                                <p className="text-xs font-medium text-white/80 leading-relaxed">
                                    Our production system utilized intelligent cloud-syncing to ensure zero data loss during the creative phase.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="project-detail-animate space-y-8">
                        <div className="p-10 bg-[#111e48] rounded-[2.5rem] border border-white/5 sticky top-24">
                            ...
                            <p className="text-xs text-white/50 mb-8 leading-relaxed">Let's discuss how our workflow solutions can be applied to your specific studio requirements.</p>
                            <button
